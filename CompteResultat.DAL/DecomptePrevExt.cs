...
namespace CompteResultat.DAL
{
    ...
    public partial class DecomptePrev
    {
        ...
        public static List<DecomptePrevReduced> GetDecomptesForDossierList(List<string> dossiers, DateTime dateArret)
        {
            try
            {
                ...
                {
                    decomptes = context.DecomptePrevs
                        .Where(dec => dossiers.Contains(dec.Dossier) && dec.DatePayement <= dateArret)
